            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>{{ session()->get('lang') === 'ro' ? 'Ești sigur/ă?' : 'Are you sure ?' }}</h4>
                        <p class="text-muted mx-4 mb-0">{{ session()->get('lang') === 'ro' ? 'Sigur vrei să elimini acest element?' : 'Are you sure you want to remove this item?' }}</p>
                    </div>
                </div>
