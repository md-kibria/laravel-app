...
@endsection
@section('content')
    <x-breadcrumb title="Create post" pagetitle="post" />
    <form action="/admin/posts/store" class="needs-validation" enctype="multipart/form-data" method="POST">
        @method('POST')
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title.en') is-invalid @enderror"
                                id="post-title-input" value="{{ old('title.en') }}" placeholder="Enter post title"
                                name="title[en]">
                            @error('title.en')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title.ro') is-invalid @enderror"
                                id="post-title-input" value="{{ old('title.ro') }}" placeholder="Enter post title"
                                name="title[ro]">
                            @error('title.ro')
                                <div class="invalid-feedback text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('content.en') is-invalid @enderror" id="service-dec-en"
                                placeholder="Enter content in English" name="content[en]">{{ old('content.en') }}</textarea>
                            @error('content.en')
                                <div class="invalid-feedback text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('content.ro') is-invalid @enderror" id="service-dec-ro"
                                placeholder="Enter content in Romanian" name="content[ro]">{{ old('content.ro') }}</textarea>
                            @error('content.ro')
                                <div class="invalid-feedback text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="flex-grow-1">
                                ...
                                <textarea class="form-control @error('excerpt.en') is-invalid @enderror" placeholder="Enter excerpt in english" rows="3"
                                    name="excerpt[en]">{{ old('excerpt.en') }}</textarea>
                                     @error('excerpt.en')
                                    <div class="invalid-feedback text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="flex-grow-1">
                                ...
                                <textarea class="form-control @error('excerpt.ro') is-invalid @enderror" placeholder="Enter excerpt in romanian" rows="3"
                                    name="excerpt[ro]">{{ old('excerpt.ro') }}</textarea>
                                     @error('excerpt.ro')
                                    <div class="invalid-feedback text-danger">{{ $message }}</div>
                                @enderror
                            </div>
