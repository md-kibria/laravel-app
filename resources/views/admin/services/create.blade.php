...
@endsection
@section('content')
    <x-breadcrumb title="Create service" pagetitle="Service" />
    <form action="/admin/services" class="needs-validation" enctype="multipart/form-data" method="POST">
        @method('POST')
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name.en') is-invalid @enderror"
                                id="product-title-input" value="{{ old('name.en') }}" placeholder="Enter product title"
                                name="name[en]">
                            @error('name.en')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name.ro') is-invalid @enderror"
                                id="product-title-input" value="{{ old('name.ro') }}" placeholder="Enter product title"
                                name="name[ro]">
                            @error('name.ro')
                                <div class="invalid-feedback text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('description.en') is-invalid @enderror" id="service-dec-en"
                                placeholder="Enter description in English" name="description[en]">{{ old('description.en') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('description.ro') is-invalid @enderror" id="service-dec-ro"
                                placeholder="Enter description in Romanian" name="description[ro]">{{ old('description.ro') }}</textarea>
                        ...
                        <div class="mb-3">
                            <div class="flex-grow-1">
                                ...
                                <textarea class="form-control" placeholder="Enter short description in english" rows="3"
                                    name="short_description[en]">{{ old('short_description.en') }}</textarea>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="flex-grow-1">
                                ...
                                <textarea class="form-control" placeholder="Enter short description in romanian" rows="3"
                                    name="short_description[ro]">{{ old('short_description.ro') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- end card body -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="flex-grow-1">
                                ...
                                <textarea class="form-control" placeholder="Enter seo description" rows="3" name="seo_description">{{ old('seo_description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- end card body -->
