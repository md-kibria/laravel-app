                ...
                <div class="col-md-4 col-6 d-none d-xxl-block">
                    <div class="d-flex align-items-center justify-content-center gap-3 fs-14 fw-medium">
                        @if (config('site_email'))
                            <a href="mailto:{{ config('site_email') }}" class="text-reset text-decoration-none">
                        ...
                        <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                            <button type="button"
                                ...
                                @switch(Session::get('lang'))
                                    @case('ro')
                                        <img src="{{ URL::asset('build/images/flags/ro.svg') }}" class="rounded-circle me-2"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a href="/change?lang=en" class="dropdown-item notify-item language py-2" data-lang="en"
                                    title="English">
                                ...
                                <!-- item-->
                                <a href="/change?lang=ro" class="dropdown-item notify-item language" data-lang="sp"
                                    title="Romania">
